...
;// CONCATENATED MODULE: ./src/js/scripts/transfer-element.js
...
;// CONCATENATED MODULE: ./src/js/components/tabs-slider.js
...
;// CONCATENATED MODULE: ./src/js/scripts/product-filter.js
function accordion(selector, options) {
  const accordion = typeof selector === 'string' ? document.querySelector(selector) : selector;
  if (!accordion) return;
...
(function () {
  ...
  const btnOpenRegister = document.querySelector('.register-form__btn-open-register');
...
let im = new inputmask_es6('+7 (999) 999-99-99');
im.mask(inputsTel);
;// CONCATENATED MODULE: ./src/js/scripts/product-details.js
